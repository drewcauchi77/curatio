...
<template>
    <div
        class="sidebar-container border-border bg-card fixed flex h-screen flex-col border-r transition-all duration-300 ease-in-out"
        :class="[statusStore.isMobile ? 'w-16' : statusStore.isMenuCollapsed ? 'w-16' : 'w-64']"
    >
        ...
        <div class="border-border border-t p-2">
            ...
            >
                ...
                <span
                    ...
                    :class="statusStore.isMenuCollapsed ? 'ml-0 w-0 opacity-0' : 'ml-3 w-auto opacity-100'"
                >
                    Collapse
                </span>
            </button>
