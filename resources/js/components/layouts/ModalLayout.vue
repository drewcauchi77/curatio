...
<template>
    <div class="fixed inset-0 z-50 flex items-center justify-end bg-black/50 opacity-100 transition-opacity duration-300">
        ...
        <div class="bg-background relative h-full w-full max-w-[97%] transform overflow-y-auto shadow-xl transition-all duration-300 ease-in-out sm:max-w-[550px]"
            ...
            <div class="border-border bg-background sticky top-0 z-10 flex items-center justify-between border-b p-4">
                ...
                <button class="text-foreground-light focus:ring-primary cursor-pointer rounded-full p-1 opacity-80 hover:opacity-100 focus:ring-2 focus:outline-none" 
